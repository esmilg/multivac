  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'beginner_tutorials' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Ethan Smilg <ethan.smilg@case.edu>, Diego Villafuerte <drv14@case.edu>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'beginner_tutorials' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/user/catkin_ws/src/beginner_tutorials/${idir}'.  Ask the maintainer 'Ethan Smilg <ethan.smilg@case.edu>, Diego Villafuerte <drv14@case.edu>' to fix it.")
    endif()
